...
df_data.loc[:, ["positivi_su_tamponi", "nuovi_positivi"]].plot(secondary_y='nuovi_positivi', ax=ax, color=["darkblue", "darkred"], rot="vertical", marker='o')
...
fig, ax = plt.subplots(figsize=(14, 7))
df_data.loc[:, ["positivi_su_casi_testati", "nuovi_positivi"]].plot(secondary_y='nuovi_positivi', ax=ax, color=["darkcyan", "darkred"], rot="vertical", marker='o')
ax.set_axisbelow(True)
ax.minorticks_on()
ax.grid(which='major', linestyle='-', linewidth='0.5', color='black')
ax.grid(which='minor', linestyle=':', linewidth='0.5', color='grey')
...
fig, ax = plt.subplots(figsize=(14, 7))
df_data.loc[:, ["totale_ospedalizzati", "nuovi_deceduti"]].plot(secondary_y='nuovi_deceduti', ax=ax, color=["darkorange", "black"], rot="vertical", marker='o')
ax.set_axisbelow(True)
ax.minorticks_on()
ax.grid(which='major', linestyle='-', linewidth='0.5', color='black')
ax.grid(which='minor', linestyle=':', linewidth='0.5', color='grey')
...
for r in array_regioni:
    ...
    fig, ax = plt.subplots(figsize=(14, 7))
    df_data_r.loc[:, ["positivi_su_tamponi", "nuovi_positivi"]].plot(secondary_y='nuovi_positivi', ax=ax, color=["darkblue",  "darkred"], rot="vertical", marker='o')
    ax.set_axisbelow(True)
    ax.minorticks_on()
    ax.grid(which='major', linestyle='-', linewidth='0.5', color='black')
    ax.grid(which='minor', linestyle=':', linewidth='0.5', color='grey')
    ...
    fig, ax = plt.subplots(figsize=(14, 7))
    df_data_r.loc[:, ["totale_ospedalizzati", "nuovi_deceduti"]].plot(secondary_y='nuovi_deceduti', ax=ax, color= ["darkorange", "black"], rot="vertical", marker='o')
    ax.set_axisbelow(True)
    ax.minorticks_on()
    ax.grid(which='major', linestyle='-', linewidth='0.5', color='black')
    ax.grid(which='minor', linestyle=':', linewidth='0.5', color='grey')
